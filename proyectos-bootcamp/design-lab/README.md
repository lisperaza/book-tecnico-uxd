...
<table><thead><tr><th width="76">⚪️</th><th width="274">Meta de aprendizaje</th><th width="81" data-type="checkbox">Hito 1</th><th width="75" data-type="checkbox">Hito 2</th><th width="73" data-type="checkbox">Hito 3</th><th width="75" data-type="checkbox">Hito 4</th><th width="81" data-type="checkbox">Hito 5</th><th width="74" data-type="checkbox">Hito 6</th></tr></thead><tbody><tr><td>🔴</td><td>Planificación ágil</td><td>true</td><td>true</td><td>true</td><td>true</td><td>true</td><td>true</td></tr><tr><td>🔴</td><td>Entendimiento del negocio</td><td>true</td><td>true</td><td>false</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟣</td><td>Planteamiento de la investigación</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟣</td><td>Técnicas exploratorias (cualitativas)</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟣</td><td>Técnicas analíticas (cuantitativas)</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟣</td><td>Análisis de la investigación</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟡</td><td>Concepto de diseño</td><td>false</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟡</td><td>Diseño de interacción</td><td>false</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟡</td><td>Diseño de contenido</td><td>false</td><td>false</td><td>true</td><td>false</td><td>false</td><td>false</td></tr><tr><td>🟡</td><td>Diseño de interfaces</td><td>false</td><td>false</td><td>false</td><td>true</td><td>false</td><td>false</td></tr><tr><td>🟢</td><td>Prototipado</td><td>false</td><td>false</td><td>false</td><td>true</td><td>false</td><td>true</td></tr><tr><td>🟢</td><td>Análisis de usabilidad</td><td>false</td><td>false</td><td>false</td><td>true</td><td>false</td><td>false</td></tr><tr><td>🟢</td><td>Pitch de diseño</td><td>true</td><td>true</td><td>true</td><td>true</td><td>true</td><td>true</td></tr><tr><td>🔵</td><td>Especificaciones de diseño</td><td>false</td><td>false</td><td>true</td><td>true</td><td>true</td><td>true</td></tr><tr><td>🔵</td><td>Sistemas y librerías de diseño</td><td>false</td><td>false</td><td>false</td><td>true</td><td>true</td><td>true</td></tr></tbody></table>
...
<summary>Hito 1: Entendimiento del proyecto (obligatorio)</summary>

Para definir el proyecto es necesario contar con un entendimiento básico del negocio, el proyecto y los objetivos por alcanzar. Es clave que tengas una idea general de las tareas y posibles entregables, para que puedas distribuir el tiempo de la mejor forma posible.

**Criterios de aceptación:**

1. Documentación que sintetice el modelo de negocio, los objetivos del proyecto y los indicadores clave que quieren impactar los y las stakeholders;
2. Plan de trabajo que incluya el alcance general del proyecto, posibles entregables, principales tareas por realizar y fechas estimadas;

Es una buena práctica realizar 2 planes de trabajo con diferentes enfoques, uno optimista y otro pesimista, así tendrás idea sobre cómo "cortar camino" cuando las cosas no salen como según esperabas. Trata de identificar tareas y entregables clave vs deseable.&#x20;

</details>

<details>

<summary>Hito 2: Descubrimiento del problema (obligatorio)</summary>

Es posible con que te enfrentes a situaciones particulares, como la creación de productos técnicos para usuarios internos, o productos nuevos que aún no cuentan con usuarios. El proceso de diseño solamente es una guía, lo puedes adaptar a tus necesidades, lo importante es identificar con claridad el problema por resolver.&#x20;

**Criterios de aceptación:**

1. Planificación del tipo de investigación que decidan implementar, incluyendo una explicación del porqué usarán la(s) técnicas seleccionadas (justificación), objetivos de investigación, perfil del usuario meta (si aplica) y tamaño de la muestra;
2. Guías de investigación de acuerdo a la técnica que hayan seleccionado y evidencia de que validaron estas guías con una persona externa al equipo (idealmente un usuario);
3. Procesamiento de la información (categorización por afinidad, resultados de encuestas, transcripciones, etc.);
4. Visualización de la experiencia de usuario (mapas de empatía, user journey, blueprint, etc.) dependiendo de la necesidad del proyecto y la investigación;
5. Síntesis de resultados, donde se muestren los patrones identificados, las observaciones y hallazgos (en caso de que existan);
6. Priorización del problema por resolver, según las necesidades del usuario y los objetivos del negocio.
...
2. Flujos de usuario con el listado de pantallas y flujos alternativos en caso de error, identificando pantallas críticas o principales;
3. Detalle de la arquitectura de información y las modificaciones propuestas en caso de ser necesario. Considera principios de usabilidad;
4. Contenido visual (imágenes, iconos) y micro-copy para UX, con apoyo de herramientas de inteligencia artificial en caso de ser útil.

**Pro-tip:** NO TE SALTES ESTE HITO! Puede parecerte una pérdida de tiempo realizar flujos y wireframes, pero es la estructura invisible que le da forma a tu propuesta y facilita mucho la elaboración de los diseños finales. Además, es una buena práctica utilizar los flujos para priorizar el diseño de las pantallas principales.
...
1. Propuesta de diseño visual con los principales cambios y mejoras. Considera principios de accesibilidad;
2. Prototipo(s) en el nivel de fidelidad e interacciones adecuadas según el proyecto;
3. &#x20;Versión mobile y desktop si el proyecto lo requiere. Puedes realizar un diseño diferente para cada dispositivo de ser necesario ([responsivo vs adaptable](https://coda.io/d/Bootcamp-UX-Contenido\_dqkqk2rV9Z2/Introduccion-a-Responsive-design\_suTmA));
4. Validación del diseño mediante pruebas de usabilidad. Si es necesario, itera la propuesta con base en el feedback de las personas usuarias.

**Pro-tip:** Concéntrate en completar los fundamental primero y deja los detalles para el final (interacciones que toman mucho tiempo, configuraciones de auto-layout, etc.).
...
2. Creación de la librería de componentes automatizados en caso de que la empresa no cuente con un sistema de diseño.
