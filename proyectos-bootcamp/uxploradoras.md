...
<mark style="background-color:green;">**Trabajando en equipo, diseñarás desde cero un dashboard para mercadeo, con foco en la jerarquía y arquitectura de la información (agrupación, etiquetas, navegación), así como crear una propuesta para la interfaz visual (layout, espaciado, colores, tipografía, etc.).**</mark>
